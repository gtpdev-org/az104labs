...
@description('Constant value to indicate no availability zones')
...
var network = networkDeployment.outputs
...
module appVNetFirewall 'br/public:avm/res/network/azure-firewall:0.6.1' = {
  ...
  params: {
    ...
    virtualNetworkResourceId: network.vnets.appVNet.resourceId
        ...
        ipConfigurations: [
          {
            ...
            subnetResourceId: network.vnets.appVNet.subnets.frontend.resourceId
        ...
        ipConfigurations: [
          {
            ...
            subnetResourceId: network.vnets.appVNet.subnets.backend.resourceId
            pipConfiguration: {
